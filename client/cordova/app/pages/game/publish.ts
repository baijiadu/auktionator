...
import {SelectProductPage, ProductDetailPage, AkGamesPage, SelectCoverPage} from '../../pages/index';
import {UserService, GameService, ProductService} from '../../providers/index';
...
export class GamePublishPage {
  ...
  uploadCover() {
    return new Promise((resolve, reject) => {
      this.generateCover().then((canvas: any) => {
